...
global bus_v  OLC_gain  OLC_mod OLCtime disturbance_size disturbance_mod controlled_load OLC_bus DELAY control_gen_mod
global OLC_capacity
global GLB_bus
...
if METHOD==Method.proposed || METHOD==Method.proposed_dc
   f=0; % dummy variable
   if n_lmod>0
      timestep=0.01;
