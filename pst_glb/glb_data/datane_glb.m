...
bus=[
  ...
  27   1.0399 -8.78   0.00000   0.0000   2.8100   0.7550 0.00000 0.00000 3 99  -99 1.0   0     0;
...
% change inertia to smaller values
inertia_rate = 1;
mac_con(:,16) = mac_con(:,16)/inertia_rate;
...
END_TIME  0    0    0    0    0    0]; % end simulation